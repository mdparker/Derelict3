...
private
{
    ...
    static if(Derelict_OS_Windows)
		...
		enum libNames = "libSDL2_image.so, libSDL2_image-1.2.so, libSDL2_image-1.2.so.0, /usr/local/lib/libSDL2_image.so, /usr/local/lib/libSDL2_image-1.2.so, /usr/local/lib/libSDL2_image-1.2.so.0";
    else
