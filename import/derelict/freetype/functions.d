...
extern(C)
{
    ...
    alias FT_Error function(FT_Library library, const(char)* filepathname, FT_Long face_index, FT_Face *aface) da_FT_New_Face;
    ...
    alias FT_Error function(FT_Face face, const(char)* filepathname) da_FT_Attach_File;
    ...
    alias const(char)* function(FT_Face face) da_FT_Get_Postscript_Name;
    ...
    alias FT_Module function(FT_Library library, const(char)* module_name) da_FT_Get_Module;
    ...
    alias FT_Error function(FT_Face face, const(char)** acharset_encoding, const(char)** acharset_registry) da_FT_Get_BDF_Charset_ID;
    alias FT_Error function(FT_Face face, const(char)* prop_name, BDF_PropertyRec *aproperty) da_FT_Get_BDF_Property;
    ...
    alias const(char)* function(FT_Face face) da_FT_Get_X11_Font_Format;
